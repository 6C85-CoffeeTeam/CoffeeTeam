<script>
    ...
    d3.json(
       "https://raw.githubusercontent.com/austinjstromme/CoffeeTeam/main/coffee-app/src/data/world.geojson"
    ).then((data) => {
      GlobalMapDataset  = data.features;
    });
    d3.json(
       "https://raw.githubusercontent.com/austinjstromme/CoffeeTeam/main/coffee-app/src/data/northerntriangleclimate.geojson"
    ).then((data) => {
